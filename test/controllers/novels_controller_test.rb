...
class NovelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create novel" do
    assert_difference('Novel.count') do
      post novels_url, params: { novel: { biz_date: @novel.biz_date, content: @novel.content, title: @novel.title } }
    end
  ...
  test "should update novel" do
    patch novel_url(@novel), params: { novel: { biz_date: @novel.biz_date, content: @novel.content, title: @novel.title } }
